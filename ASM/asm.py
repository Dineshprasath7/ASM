...
def banner():
    red_color = "\033[91m"
    reset_color = "\033[0m"
    ascii_banner = pyfiglet.figlet_format("ASM")
    print(red_color + ascii_banner + reset_color)
...
def parse_args():
	...
	parser.add_argument('--maxdepth', help='Bruteforce from aaaa to zzzz.domain.ltd. Only possible value is 4, otherwise, ASM will use 3 as maxdepth', type=int, default=3)
	...
	parser.add_argument('--version', help='Show ASM version and exit', action='store_true')
